...
\newenvironment{env-25449dba-675e-416d-93ff-e01124770983}
{
...
\newenvironment{env-4980839e-5e10-498c-b437-06fa3bc3d0df}
{
...
\newenvironment{env-f5f7f3d8-d1e9-42cb-af52-f19251460e80}
{
...
\newenvironment{env-dbb19bfd-c700-4f39-918f-d769b7ab68c9}
{
...
\newenvironment{env-699460e4-9f8f-43fe-bf0e-e0ce66ec4566}
{
...
\newenvironment{env-32ff2096-36f9-49b5-95fc-8385c147afc3}
{
...
\newenvironment{env-7a57292a-678d-49ef-822d-738808b95290}
{
...
\newenvironment{env-60a48917-a965-485c-8e81-1078f530f093}
{
...
\newenvironment{env-984f44dc-22fb-46e2-8618-a639d42f6cae}
{
...
\newenvironment{env-dfe277e3-f0b5-4283-95a0-9a2955ca1697}
{
    \savenotes\tcolorbox[blanker,breakable,left=5pt,borderline west={2pt}{-4pt}{cyan}]
}
{
...
\newenvironment{env-c0ccbe0b-3487-4904-8400-ba10876d9867}
{
...
\newenvironment{env-a2f03dc7-c1ac-4ef6-9230-a1bf847724bf}
{
...
\newenvironment{env-3271c9bd-4e4c-47f5-9922-d2405d5600a8}
{
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.0743}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.9257}}@{}}
\toprule()
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.2472}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.7528}}@{}}
\toprule()
\begin{minipage}[b]{\linewidth}\raggedright
Term
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.9454}}@{}}
\toprule()
\begin{minipage}[b]{\linewidth}\raggedright
Unity
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.5733}}@{}}
\toprule()
\begin{minipage}[b]{\linewidth}\raggedright
Joint tenancy
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.1169}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.8831}}@{}}
\toprule()
\begin{minipage}[b]{\linewidth}\raggedright
Case
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.0928}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.9072}}@{}}
\toprule()
\begin{minipage}[b]{\linewidth}\raggedright
Paragraph
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.0894}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.9106}}@{}}
\toprule()
\begin{minipage}[b]{\linewidth}\raggedright
Application for
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
